...
(function ($) {
            ...
            _this
                ...
                .on("update.countdown", function (event) {
                    _this.html(
                        event.strftime(
                            "" +
                                '<div class="counter-container"><div class="countdown-box first"><div class="number">%-D</div><span>Dias</span></div>' +
                                ...
                                '<div class="countdown-box last"><div class="number">%S</div><span>Segundos</span></div></div>',
                        ),
                    );
                })
        ...
        if (animeOptions && getWindowWidth() > animeBreakPoint) {
            try {
                ...
                $self.on("appear", function () {
                    if (
                        $self.hasClass("appear") ||
                        $self.hasClass("animating")
                    ) {
                        return;
                    }
    ...
    const slideTextAnimation = (target, options) => {
        ...
        target
            .querySelectorAll(".anime-text > .word > .char")
            .forEach((char) => {
    ...
    const waveTextAnimation = (target, options) => {
        ...
        const waveTextchar = target.querySelectorAll(
            ".anime-text > .word > .char",
        );
    ...
    const jumpTextAnimation = (target, options) => {
        ...
        const jumpTextchar = target.querySelectorAll(
            ".anime-text > .word > .char",
        );
    ...
    const zoomTextAnimation = (target, options) => {
        ...
        const zoomchars = target.querySelectorAll(
            ".anime-text > .word > .char",
        );
    ...
    const fadeTextAnimation = (target, options) => {
        ...
        const fadeTextchar = target.querySelectorAll(
            ".anime-text > .word > .char",
        );
        ...
        if (content) {
            ...
            if (getWindowWidth() > animeBreakPoint) {
                ...
                if (text_effect === undefined) {
                    animate(
                        item.querySelectorAll(".anime-text > .word > .char"),
                        {
                            ...ftOptions,
            ...
            handleScroll() {
                if (!this.ticking) {
                    window.requestAnimationFrame(() => {
                        ...
                        percent =
                            (percent - this.triggerOffset) /
                            (1 - this.triggerOffset);
